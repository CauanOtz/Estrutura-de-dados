...
public class Main {
    public static void main(String[] args) {
        String opcoes = "Escolha uma opção:\n"
                ...
                + "6. Salvar Matriz em Arquivo\n"
                + "7. Carregar Matriz de Arquivo\n"
                + "8. Sair";
        ...
        while (true) {
            ...
            switch (escolha) {
                ...
                case "5":
                    ...
                    break;
                case "6":
                    String nomeArquivoSalvar = JOptionPane.showInputDialog("Informe o nome do arquivo para salvar:");
                    grafo.salvarEmArquivo(nomeArquivoSalvar);
                    break;
                case "7":
                    String nomeArquivoCarregar = JOptionPane.showInputDialog("Informe o nome do arquivo para carregar:");
                    grafo.carregarDeArquivo(nomeArquivoCarregar);
                    break;
                case "8":
                    System.exit(0);
                    break;
